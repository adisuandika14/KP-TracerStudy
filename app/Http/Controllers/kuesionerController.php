...
class kuesionerController extends Controller
{
    ...
    public function create(Request $request){
        ...
        //     ]);
        return redirect('/admin/kuesioner')->with('success','Data berhasil disimpan!');
    }

    public function delete($id){
        $delete = tb_kuesioner::find($id);
        $delete->delete();
        return redirect ('/admin/kuesioner')->with('success','Data berhasil dihapus!'); 
    }
    ...
    public function update(Request $request){
        ...
        $updatedata->update();
        //dd($updatedata);
       return redirect('/admin/kuesioner')->with('success','Data berhasil diupdate!');
    }
