...
class alumniController extends Controller
{
    ...
    // dd($alumni);
        return view('/alumni/dataalumni', compact ('alumni','prodi','angkatan','gender','province','regencies','districts','villages'));
    }
    ...
    public function create(Request $request){
            ...
            return redirect('/admin/alumni')->with('success','Data berhasil disimpan!');
    ...
    //     return response()->json(['success' => 'Berhasil', 'alumni' => $editdata]);
    // }
